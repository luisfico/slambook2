// RUN $ ./build/dense_mono/dense_mapping /home/lc/datasets/pxEnvVO/datasetVuzixTool119/hipCenter/CapturesJPG/aSelectEnvironmentFixContinousCapture/imagesROI700
    ...
    cv::Mat &ref_depth)
{
    ...
    while (!fin.eof())
    {
        ...
        color_image_files.push_back(path + string("/imagesROI700/") + image);
        poses.push_back(
